  ...
  Widget _buildTabBar() {
    return Container(
      color: const Color.fromARGB(
          0, 0, 0, 0), // Ensure there's no extra pixel color
      child: TabBar(
        controller: _tabController,
        isScrollable: true,
        indicatorColor: Colors.black, // Set the indicator color to black
        indicatorWeight:
            0.1, // Adjust the thickness of the indicator line if needed
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildWatchlistSection(
            "comfort zone",
            ["F**** C***", "Dead Poet Society","The Perks of Being a
        ...
        Align(
          ...
          child: Container(
            ...
            child: Text(
              ...
              textAlign: TextAlign
                  .left, // Align the text inside the container to the left
            ),
          ),
        ),
